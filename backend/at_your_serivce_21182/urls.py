"""at_your_serivce_21182 URL Configuration
...
admin.site.site_header = "At Your Serivce"
admin.site.site_title = "At Your Serivce Admin Portal"
admin.site.index_title = "At Your Serivce Admin"

# swagger
api_info = openapi.Info(
    title="At Your Serivce API",
    default_version="v1",
    description="API documentation for At Your Serivce App",
)
